...
CREATE TABLE profiles (
    ...
    last_active_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,   -- Thời điểm hoạt động gần nhất
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,       -- Thời điểm tạo
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP        -- Thời điểm cập nhật gần nhất
);
...
CREATE TABLE action_credit_values (
